...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Grapo - Gestão de Aluguel de Ativos',
        short_name: 'Grapo',
        description: 'Transforme seus equipamentos parados em renda recorrente. Gerencie aluguéis, contratos e cobranças em um só lugar.',
        theme_color: '#606F40',
